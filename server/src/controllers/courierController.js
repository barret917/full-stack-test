...
// export const getTotalDistCourier = async (req, res) => {
//   try {
//     const { courierId } = req.params;
//     const total = await Order.sum('distance', {
//       where: {
...
//   } catch (err) {
//     res.status(500).send('Не удалось сложить дистанцию ');
//   }
// };
...
//   } catch (err) {
//     res.status(500).send('Не удалось получить курьера по id');
//   }
// };
...
//   try {
//     const { courierId } = req.params;
//     const count = await Order.count({ where: { courier_id: courierId } });
//     return res.json({ count });
//   } catch (err) {
//     res.status(500).send('Не удалось получить количество доставок у курьера');
//   }
// };

// export const getCourierParametr = async (req, res) => {
//   try {
//     const { region, nationality } = req.query;
//     let whereCondition = {};
//     if (region) {
...
//     res
//       .status(500)
//       .send('Не удалось получить курьеров исходя из города или района');
//   }
// };

// export const putNotActive = async (req, res) => {
//   try {
//     const { courierId } = req.params;
//     const courier = await Courier.findByPk({
//       where: {
//         id: courierId,
//       },
//     });
...
//     await courier.save();
//     return res.json({
//       message: 'Статус курьера изменен',
//       isActive: courier.isActive,
//     });
//   } catch (err) {
//     res.status(500).send('Не удалось обновить isActive у курьера');
//   }
// };
